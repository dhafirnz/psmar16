...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "psmar16@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "psmar16 API";

        private String description = "psmar16 API documentation";
