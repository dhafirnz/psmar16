...
import nz.co.threepoints.ps.repository.search.UserSearchRepository;
...
import nz.co.threepoints.ps.web.rest.dto.ManagedUserDTO;
import nz.co.threepoints.ps.web.rest.dto.UserDTO;
import nz.co.threepoints.ps.web.rest.util.HeaderUtil;
import nz.co.threepoints.ps.web.rest.util.PaginationUtil;
    ...
    public ResponseEntity<ManagedUserDTO> updateUser(@RequestBody ManagedUserDTO managedUserDTO) throws URISyntaxException {
        ...
        return userRepository
            ...
            .map(user -> {
                ...
                user.setCompanys(managedUserDTO.getCompanys());
